...
from cbir_mm_fgw.tiling import TilingMode
...
def run(c: Config):
    ...
    print("==== Inspect ====")
    # inspect the builtin pipeline after the warmup (and reset the profiler)
