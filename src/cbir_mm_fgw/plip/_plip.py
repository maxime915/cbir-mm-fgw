"""
_plip: Implementation of the PLIP model by PathologyFoundation.

This code has been copied and pasted from the PLIP repository with one modification.
Source: https://github.com/PathologyFoundation/plip/blob/f010f3d0bef20f4e8cc64cc26c301cbd26305fa1/plip.py
"""
...
class PLIP:
    ...
    def _load_model(self,
        ...
        # NOTE (modification #1): added "use_fast=True" below
        preprocessing = CLIPProcessor.from_pretrained(name, use_auth_token=auth_token, use_fast=True)
